...
SquareBuilder.prototype = {
    ...
    update: function (seriesModel, ecModel, api, start, end) {
        ...
        var cellSize = [xAxis.getBandWidth(), yAxis.getBandWidth()];

        var symbolInfo = this._getSymbolInfo(seriesModel, start, end, cellSize);
        ...
        for (var i = 0; i < end - start; i++) {
            ...
            /* Apply symbol size by category cell size */
            var symbolSize = cellSize;
    ...
    _getSymbolInfo: function (seriesModel, start, end, cellSize) {
        ...
        var symbolType = data.getItemVisual(0, 'symbol') || 'rect';
        var differentSymbolType = false;
        var maxSymbolSize = 0;

        for (var idx = start; idx < end; idx++) {
            var symbolSize = cellSize;
            var currentSymbolType = 'rect';
